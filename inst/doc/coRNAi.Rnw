...
system('neato -Tpdf interactionGraph1.dot >interactionGraph1.pdf')
@ 
...
system('neato -Tpdf interactionGraph2.dot >interactionGraph2.pdf')
@ 
...
c1 = data2graph(list("size"=cormat[[1]],"pvalues"=cormat[[2]]),
  ...
  gamma.col=0)
system('neato -Tpdf correlationGraph1.dot >correlationGraph1.pdf')
@ 
...
system('neato -Tpdf correlationGraph2.dot >correlationGraph2.pdf')
@ 
